        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    {/* blob — sm+ only, hidden on mobile to prevent layout bleed */}
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 12, width: "100%", boxSizing: "border-box" }}>
                        ...
                        {/* name + badges — min-w-0 so truncation works */}
                            ...
                            <div style={{ marginTop: 4, display: "flex", flexWrap: "wrap", gap: 4 }}>
                                ...
                                {student.semester && (
                                    <span style={{
                                        ...
                                        <GraduationCap style={{ width: 9, height: 9, flexShrink: 0 }} />
                                        {student.semester}
                                    </span>
                                )}
                                {student.user_id && (
                        ...
                        {/* course count — fixed, never wraps */}
                        <div style={{
                            flexShrink: 0,
                                    ...
                                    {HOURS.map((_, hourIdx) => {
                                        ...
                                        return (
                                            <td key={id} style={{
                                                ...
                                                filter: isMatch ? "none" : "grayscale(1)",
                                            }}>
                                                {entry && color ? (
                ...
                <div className="lg:hidden" style={{
                    ...
                    {/* Day navigator — arrows + day name + dots. No pills. */}
                    <div style={{
                        ...
                        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 4, flex: 1, minWidth: 0 }}>
                            ...
                            {/* dots — max width ~66px, safe on 320px screens */}
                            ...
                            return (
                                <div key={id} style={{
                                    ...
                                    <div style={{
                                        ...
                                        <span style={{ fontSize: 9, fontWeight: 700, color: "#475569", textAlign: "center", lineHeight: 1.3, whiteSpace: "pre-line" }}>
                                            {hour.replace(" ", "\n")}
                                        </span>
                                    </div>

                                    {/* card — flex:1 + minWidth:0 prevents overflow */}
                                    <div style={{ flex: 1, minWidth: 0, padding: 8, boxSizing: "border-box" }}>
                                        {entry && color ? (
                                            <div className={`rounded-xl border ${color.border} ${color.bg} p-2`} style={{ width: "100%", boxSizing: "border-box" }}>
                                                ...
                                                {/* instructor + room row */}
                                                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 6, borderTop: "1px solid rgba(255,255,255,0.6)", paddingTop: 6, minWidth: 0 }}>
